# This file maintains backward compatibility by importing all CRUD functions from the modular structure
# The actual CRUD functions are now organized in the crud/ directory for better maintainability

# Import all functions from the modular crud package
from .crud import *
