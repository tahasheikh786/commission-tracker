...
export default function ReviewDemo({
  ...
  const steps = [
    ...
    { key: 'review', label: 'Review', icon: CheckCircle, description: 'Final review' }
  ] as const
  
  const currentStep = 'review'
  const completedSteps = new Set(['upload', 'process', 'mapping'])
    ...
    <div className={`fixed inset-0 bg-white dark:bg-slate-900 z-50 flex flex-col ${isFullscreen ? 'z-[9999]' : ''}`}>
      ...
      <div className="px-6 py-4 border-b border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 flex items-center justify-between flex-shrink-0">
        <div className="flex items-center gap-4 flex-wrap">
          ...
          <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-200">Review Demo</h2>
      ...
      <div className="flex-1 flex flex-row gap-4 p-4 bg-slate-50 dark:bg-slate-900 min-h-0 overflow-hidden max-h-full">
        ...
        {showPreview && (
          <div className="w-2/5 bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 overflow-hidden flex flex-col min-h-0">
            ...
            <div className="flex-1 flex items-center justify-center bg-slate-50 dark:bg-slate-700/30 p-4 overflow-hidden">
              <div className="text-center">
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400">Commission Statement Demo</p>
            ...
            {/* PDF Footer */}
            <div className="border-t border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-700/30 px-4 py-3 flex items-center justify-end flex-shrink-0">
                  ...
                  <tbody>
                    {pagedRowsWithHeaders.map((item, i) => {
                      if (item.type === 'row') {
                        ...
                        return (
                          <tr key={globalIdx} className="hover:bg-slate-100 dark:hover:bg-slate-700/50 group relative transition-all duration-200 hover:shadow-sm">
                            {/* Checkbox column */}
                            ...
                            {Array.isArray(row) ? (
                              ...
                              row.map((val: string, colIdx: number) => (
                                <td key={colIdx} className="px-3 py-3 text-xs text-slate-800 dark:text-slate-200 border-b border-slate-200 dark:border-slate-700 border-r border-slate-200 dark:border-slate-700 last:border-r-0 whitespace-nowrap">
                                  {isEditing
                                    ? (
                                      <input
                            ...
                            <td className="px-3 py-3 text-xs text-slate-800 dark:text-slate-200 border-b border-slate-200 dark:border-slate-700 border-r border-slate-200 dark:border-slate-700 relative">
                              {!isEditing ? (
                                <div className="flex gap-2">
                                  <button 
                                    className="p-1.5 text-blue-500 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition-all duration-200 hover:shadow-sm cursor-pointer"
                                  ...
                                  <button 
                                    className="p-1.5 text-red-500 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-all duration-200 hover:shadow-sm cursor-pointer"
                                ...
                                <div className="flex gap-2">
                                  <button 
                                    className="p-1.5 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 rounded-lg transition-all duration-200 hover:shadow-sm cursor-pointer"
                                    onClick={saveEdit}
                                    title="Save"
                                  >
                                    <Check size={12} />
              ...
              <div className="border-t border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-700/30 px-4 py-3 flex items-center justify-between flex-shrink-0">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-2 bg-white dark:bg-slate-700 rounded-lg px-3 py-2">
                    ...
                    <span className="text-sm text-slate-800 dark:text-slate-200 font-medium truncate block min-w-[140px] max-w-[200px]" title={rows[0]?.name || 'Untitled Table'}>
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="px-3 py-2 bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 hover:bg-blue-500 hover:border-blue-500 hover:text-white transition-all duration-200 flex items-center gap-2 cursor-pointer hover:shadow-sm rounded-lg"
      ...
      <div className="bg-white dark:bg-slate-800 border-t border-slate-200 dark:border-slate-700 px-4 py-3 shadow-lg flex-shrink-0">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <button
                onClick={handleReset}
                className="px-3 py-2 bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 hover:bg-orange-500 hover:border-orange-500 hover:text-white transition-all duration-200 flex items-center gap-2 cursor-pointer hover:shadow-sm rounded-lg text-sm"
                title="Reset data"
              >
              ...
              <button
                ...
                className="px-3 py-2 bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 hover:bg-red-500 hover:border-red-500 hover:text-white transition-all duration-200 flex items-center gap-2 cursor-pointer hover:shadow-sm rounded-lg text-sm"
              ...
              <button
                ...
                className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 flex items-center gap-2 font-medium cursor-pointer text-sm"
              >
