            ...
            <div className="w-full h-full flex flex-col">
                <div className="p-6 pb-4 border-b border-slate-200">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-slate-800">Mapped Table Preview</h2>
                            <p className="text-sm text-slate-600">Review the processed data for this statement</p>
                        </div>
                    </div>
                </div>
                <div className="flex-1 overflow-hidden px-6 py-6">
                    {transformedTables && transformedTables.length > 0 ? (
                        <div className="h-full overflow-auto bg-slate-50 rounded-xl p-4">
                            <DashboardTable
                        ...
                        <div className="text-center py-16">
                            ...
                            <h3 className="text-lg font-semibold text-slate-700 mb-2">No mapped data available</h3>
                            <p className="text-slate-500 text-sm mb-4">This statement doesn&apos;t have any processed data yet.</p>
