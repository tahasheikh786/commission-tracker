  ...
  if (isUploading) {
    return (
      <div className="w-full h-full min-h-[400px]">
        <div className="relative border-2 border-dashed rounded-2xl p-8 md:p-12 text-center transition-all duration-300 h-full flex flex-col justify-center border-blue-400 dark:border-blue-500 bg-blue-50 dark:bg-blue-900/20">
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400">
                Please wait while we extract and analyze your commission data
              </p>
            </div>
